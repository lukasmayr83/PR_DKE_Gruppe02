...
def upgrade():
    ...
    with op.batch_alter_table('dienstzuweisung', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_dienstzuweisung_mitarbeiter_id_mitarbeiter'), 'mitarbeiter', ['mitarbeiter_id'], ['id'])
    ...
    with op.batch_alter_table('fahrt_halt', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_fahrt_halt_bahnhof_id_bahnhof'), 'bahnhof', ['bahnhof_id'], ['id'])
    ...
    with op.batch_alter_table('fahrt_segment', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_fahrt_segment_von_halt_id_fahrt_halt'), 'fahrt_halt', ['von_halt_id'], ['id'])
        batch_op.create_foreign_key(batch_op.f('fk_fahrt_segment_nach_halt_id_fahrt_halt'), 'fahrt_halt', ['nach_halt_id'], ['id'])
